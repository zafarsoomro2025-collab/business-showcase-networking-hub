            ...
            <div class="business-social-sharing">
                ...
                <div class="sharing-buttons">
                    ...
                    <a href="#" 
                       ...
                       aria-label="<?php esc_attr_e( 'Share on Facebook', 'business-showcase-networking-hub' ); ?>"
                    ...
                    <a href="#" 
                       ...
                       data-url="<?php echo esc_url( get_permalink() ); ?>"
                       data-title="<?php echo esc_attr( get_the_title() ); ?>"
                       aria-label="<?php esc_attr_e( 'Share on Twitter', 'business-showcase-networking-hub' ); ?>"
                       rel="noopener noreferrer">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="#" 
                       ...
                       data-url="<?php echo esc_url( get_permalink() ); ?>"
                       data-title="<?php echo esc_attr( get_the_title() ); ?>"
                       aria-label="<?php esc_attr_e( 'Share on LinkedIn', 'business-showcase-networking-hub' ); ?>"
                       rel="noopener noreferrer">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <button type="button" 
                            ...
                            data-url="<?php echo esc_url( get_permalink() ); ?>"
                            aria-label="<?php esc_attr_e( 'Copy link', 'business-showcase-networking-hub' ); ?>">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path>
                            <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path>
                        </svg>
                        <span class="copy-text"><?php esc_html_e( 'Copy Link', 'business-showcase-networking-hub' ); ?></span>
                        <span class="copied-text" style="display: none;"><?php esc_html_e( 'Copied!', 'business-showcase-networking-hub' ); ?></span>
                    </button>
